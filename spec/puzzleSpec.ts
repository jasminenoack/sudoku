...
describe('sudoku board', () => {
    ...
    describe('process subsection steps', () => {
        beforeEach(() => {
            sudoku.blanks = { 1: [3, 4], 4: [3, 7], 5: [1, 3, 7], 6: [1, 4], 10: [5, 8], 12: [5, 9], 14: [5, 8, 9], 18: [3, 4, 8], 19: [3, 4, 5, 8], 22: [3, 5], 23: [1, 3, 5, 8], 26: [1, 4], 27: [3, 4, 7, 8, 9], 28: [3, 4, 5, 6, 8, 9], 29: [3, 4, 5], 31: [3, 5, 6, 7], 32: [3, 5, 7], 34: [4, 9], 35: [3, 4, 6, 7, 9], 36: [3, 7], 37: [1, 3, 6], 38: [1, 2, 3], 41: [2, 3, 7], 44: [1, 3, 6, 7], 45: [3, 4, 7, 9], 46: [1, 3, 4, 5, 6, 9], 47: [1, 2, 3, 4, 5], 49: [3, 5, 6, 7], 50: [2, 3, 5, 7], 51: [1, 3, 4, 7], 52: [1, 4, 9], 53: [1, 3, 4, 6, 7, 9], 57: [3, 9], 60: [3, 4], 62: [3, 4, 9], 63: [3, 4, 9], 64: [1, 3, 4, 9], 65: [1, 3, 4], 66: [3, 5, 7, 9], 68: [3, 5, 7, 9], 71: [1, 3, 4, 5, 7, 9], 74: [1, 3], 75: [3, 5, 7, 9], 78: [1, 3, 7], 79: [1, 9], 80: [1, 3, 5, 7, 9] }
            sudoku.step = { 
                "stepSections": ["square"], 
        ...
        it('steps show active', () => {
            ...
            expect(sudoku.step).toEqual({
                ...
                "valuesToPlace": {},
                "stepSubsectionsToProcess": [
                    { "indexesToCompare": [27, 28, 36, 37, 45, 46], "indexesToIgnore": [29, 38, 47], "numbersToRemove": [5] },
                    { "indexesToCompare": [58, 59, 67, 68, 76, 77], "indexesToIgnore": [57, 66, 75], "numbersToRemove": [3, 7] },
                    { "indexesToCompare": [30, 32, 39, 41, 48, 50], "indexesToIgnore": [31, 40, 49], "numbersToRemove": [6] },
                    { "indexesToCompare": [3, 4, 12, 13, 21, 22], "indexesToIgnore": [5, 14, 23], "numbersToRemove": [1, 8] },
                    { "indexesToCompare": [30, 31, 39, 40, 48, 49], "indexesToIgnore": [32, 41, 50], "numbersToRemove": [2] },
    ...
    describe('combinations', () => {
        ...
        it('changes over to combination step', () => {
            sudoku.takeStep()
            expect(sudoku.step).toEqual({ 
                "stepSections": ['row', 'column', 'square'], 
                "stepPhases": ["lookingForCombos"], 
                "stepType": "combinationStep", 
                "stepIndexes": [], 
                "stepValues": [0, 1, 2, 3, 4, 5, 6, 7, 8], 
                "stepValuesToRemove": [], 
                "stepSpotsToRemoveFrom": [], 
        ...
        it('gets index combinations', () => {
            const combinations = sudoku.getCombinations([1, 3, 4, 6, 7])
            expect(combinations).toEqual([
                [1, 3], [1, 3, 4], [1, 3, 4, 6], [1, 3, 4, 7], 
                [1, 3, 6], [1, 3, 6, 7], [1, 3, 7], 
                [1, 4], [1, 4, 6], [1, 4, 6, 7], 
                [1, 4, 7], 
                [1, 6], [1, 6, 7], 
                [1, 7], [3, 4], [3, 4, 6], [3, 4, 6, 7], 
                [3, 4, 7], [3, 6], [3, 6, 7], 
                [3, 7], [4, 6], [4, 6, 7], [4, 7], [6, 7]
            ])
        })

        it('finds combinations that are meaningful', () => {
            sudoku.takeStep()
            // first step
            sudoku.takeStep()
            expect(sudoku.step).toEqual({
        ...
        it('finds indexes with blanks', () => {
            expect(sudoku.indexWithBlanks('row', 3)).toEqual([28, 30, 33, 35])
            expect(sudoku.indexWithBlanks('square', 0)).toEqual([0, 1, 2, 9, 18, 19])
